            ...
            : Container(
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      //  _getHinhDiaDanh(bv.dia_danh!.id.toString());
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        leading: CircleAvatar(
                                          backgroundImage:
                                              AssetImage("images/travel.jpg"),
                                        ),
                                        title: Text(
                                          bv.dia_danh!.ten_dia_danh.toString(),
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 15),
