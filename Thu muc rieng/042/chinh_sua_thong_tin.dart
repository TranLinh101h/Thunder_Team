...
class ChinhSuaThongTinState extends State<ChinhSuaThongTin>{
  ...
  static const menuStatus = <String>[
    'hoạt động',
    'ẩn'
  ];

  // ignore: unused_field
  final List<PopupMenuItem<String>> _popUpMenuItems = menuStatus.map(
  ...
  Widget _ShowPersonalInformation(String txtName) {
    return ListTile(
      leading:const CircleAvatar(
        backgroundImage: AssetImage("images/avatar01.jpg"), // Khi có db từ web sẽ thay lại!
      ),
      title: Text(
        txtName,
      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: _ShowPersonalInformation('Lữ Bố'),
            ),
          _ChangeInformation(),
          Padding(
            padding:const EdgeInsets.all(10.0),
            child: Column(
              children: [
                _BuildTextField("Tên hiển thị", "Lữ Bố"),
                _BuildTextField("Giới tính", "Nam"),
                _BuildTextField("Ngày sinh", "12/12/1999"),
                _BuildTextField("Email", "bothienha@gmail.com"),
