...
class DoiMatKhauState extends State<DoiMatKhau>{ // Man update 24/01/2022 | you linh nho copy full 0.
  final TextEditingController txtpassword = TextEditingController(); // pass hien tai
  final TextEditingController txtconfirmpassword = TextEditingController();
  final TextEditingController txtOldPassword = TextEditingController(); //pass cũ
  ...
  void setPassword() async { // Khi nguoi ta doi xong thi minh se luu cai gia tri moi cho than pass neu doi nua van ok
  SharedPreferences pref = await SharedPreferences.getInstance();
      await pref.setString('password', txtpassword.text.isEmpty ? '' : txtpassword.text.toString() ); 
  }
  ...
  void _updatePass() async { // Man update 25/01/2022
              ...
              child: Column(
                ...
                children: [
                 ...
                 const Padding(
                  ...
                  Padding( // Man update 24/01/2022
                    padding: const EdgeInsets.all(8.0),
                    child: TextFormField(
                      controller: txtOldPassword,
                      obscureText: showOldPassword, // Khi thuộc tính là true thì pass sẽ show
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(5.0)
                        ),
                        hintText: 'Nhập mật khẩu cũ',         // hintStyle: TextSTyle()
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon: Icon( showOldPassword ?
                           Icons.visibility_off : Icons.remove_red_eye ,
                            color: showOldPassword ? Colors.blue : Colors.grey, // Khi _showPassword là true màu là xanh và ngược lại
                          ), )
                      ),
