...
class HomePageState extends State<HomePage>
  ...
  Min_Dia_Danh selectDiaDanh =
      Min_Dia_Danh('1', 'home'); // Man create 15/01/2022 : 22:10:23
  final GlobalKey<ScaffoldState> _scaffoldkey =
      GlobalKey<ScaffoldState>(); // Khoa chung // Man update 23/01/2022
      ...
      home: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlatButton(
              ...
              child: _loading
                  ? const CircleAvatar(
                      // Man update 26/01/2022 | fix er img
                  ...
                  : CircleAvatar(
                      backgroundImage: NetworkImage(user!.img!
                          ...
                          baseURL.substring(0, baseURL.length - 3) +
                              user!.img
                                  .toString()), // do dart khong ho tro cat quay lui giong php nen phai dung cach nay
                    ),
            ),
            centerTitle: true,
            title: SizedBox(
              // Man update 25/01/2022 | Tùy biến theo kích thước màn hình người dùng
              child: Row(
          ...
          body: Center(child: _pageOption[selectedPages]),
