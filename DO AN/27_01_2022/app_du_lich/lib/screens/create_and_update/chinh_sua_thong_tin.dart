...
class ChinhSuaThongTinState extends State<ChinhSuaThongTin> { // Man update 25/01/2022 update full nha
              ...
              image: _imageFile == null
                  ? user!.img != null
                      ? DecorationImage(
                          ...
                          image: NetworkImage('${user!.img!.contains('storage') ? user!.img.toString() : baseURL.substring(0,baseURL.length-3)+user!.img.toString()  }'),
                          fit: BoxFit.cover)
                      : null
                  : DecorationImage(
  ...
  void _hidenEmail(String stEmail) async { // update 25/01/2022
  ...
  void hidenSdt(String stSDT) async { // update 25/01/2022
