  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Container(
        ...
        child: Text("Đăng Nhập", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                }, child: Text("Đăng Ký Ngay!", style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600))
                ,)
              ],
            ),
            Row(
